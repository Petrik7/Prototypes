                    ...
                    <asp:UpdatePanel ID="GasPurchaseDetailsPanel" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                          ...
                          style="border-left: 1px solid Tan; border-right: 1px solid Tan; border-top: 1px solid Tan; border-bottom: 1px solid Tan"> 
                            ...
                            <tr class="light">
                              <td></td>
                              <td align="right"> <asp:Button ID="UpdateButton" runat="server" Text="Update" OnClick="UpdateButton_Click" /></td>
                              <td align="left"> <asp:Button ID="DeleteButton" runat="server" Text="Delete" OnClick="DeletButton_Click"  CausesValidation="false"/></td>
                              <td></td>
                            </tr>
                            <tr class="dark0">

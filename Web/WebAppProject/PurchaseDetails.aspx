<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurchaseDetails.aspx.cs" Inherits="WebAppProject.PurchaseDetails" %>
...
<head id="Head1" runat="server">
    ...
    <style type="text/css">
        ...
        table.PurchaseDetails tr.light td {background-color: #FAFAD2;}
        table.PurchaseDetails tr.dark0 td {background-color: #EEE8AA;}
    </style>
</head>
            ...
            <tr>
             ...
             <tr>
                <td style="height: 206px" valign="top">
                    <asp:UpdatePanel ID="GasPurchaseDetailsPanel" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                          <table id="Table1" class="PurchaseDetails" cellpadding="2" align="center" cellspacing = "0" runat="server" borderwidth="8"
                          style="border-left: 1px solid Tan; border-right: 1px solid Tan; border-top: 1px solid Tan; border-bottom: 1px solid Tan"> 
                            <tr style="background-color:Tan">
                                <td align="left" colspan="4"><asp:Label ID="Label1" text="Purchase details:" runat="server" /></td>
                            </tr>
                            <tr class="light">
                            ...
                            <tr class="light">
                              <td></td>
                              <td align="right"> <asp:LinkButton ID="UpdateButton" runat="server" Text="Update" OnClick="UpdateButton_Click" /></td>
                              <td align="left"> <asp:LinkButton ID="DeleteButton" runat="server" Text="Delete" OnClick="DeletButton_Click"  CausesValidation="false"/></td>
                              <td></td>
                            </tr>
                            <tr class="dark0">
